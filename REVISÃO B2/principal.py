# Criar uma aplicação capaz de armazenar dados de usuários (nome, email, idade) via terminal. 
#Crie um menu via terminal, permitindo add, remover via chave primária e visualizar a lista de usuários.
'''
import sqlite3
def criar_tabela():
    # Conectar ao banco
