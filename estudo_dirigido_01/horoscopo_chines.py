...
#### Dica: Para descobrir o seu signo no horóscopo chinês, você precisará conhecer o ano do seu nascimento de acordo com o calendário chinês. 
# O horóscopo chinês é baseado em um ciclo de 12 anos, cada ano representado por um animal do zodíaco chinês. Aqui estão os 12 animais do zodíaco chinês e os
...
def signo_chines(ano):
    ...
    calculo = (ano - 1900) % 12
    return f"Seu signo no horóscopo chinês é {signo_chines[calculo]}." 
